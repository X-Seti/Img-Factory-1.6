...
class IMGVersion1_5Creator:
    ...
    def create_version_1_5(self, output_path: str, initial_size_mb: int) -> bool:
        """Create IMG version 1.5 (DIR+IMG pair) - FIXED METHOD SIGNATURE"""
        try:
            ...
            print(f"Error creating Version 1.5 IMG: {e}")
            return False
    ...
    def create_gta3_version_1(self, output_path: str, initial_size_mb: int, game_preset: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            print(f"Error creating GTA3 Version 1.5 IMG: {e}")
            return False
    ...
    def create_vc_version_1(self, output_path: str, initial_size_mb: int, game_preset: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            print(f"Error creating VC Version 1.5 IMG: {e}")
            return False

    def create_sol_version_1_5(self, output_path: str, initial_size_mb: int, game_preset: Dict[str, Any]) -> bool:
        """Create State Of Liberty-specific Version 1.5 IMG"""
        try:
            success = self.create_version_1(output_path, initial_size_mb)

            if success:
                print(f"   State of Liberty Version 1.5 IMG created: {self.img_path}")
                print(f"   DIR file: {self.dir_path}")
                print(f"   Size: {initial_size_mb}MB")
    ...
    def get_creation_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'version': 'VER15',
                'format': 'IMG Version 1.5 (DIR+IMG)'
            }
        except Exception:
            return {}
...
def create_version_1_img(output_path: str, initial_size_mb: int = 100, 
    ...
    if game_preset:
        ...
        if game_code == 'gta3':
            ...
            return creator.create_vc_version_1_5(output_path, initial_size_mb, game_preset)
...
__all__ = [
    'IMGVersion1Creator',
    'create_version_1_5img',
    'get_version_1_5_specs'
]
