...
type
  ...
  TDFFprelight = array[0..4] of Byte;
  ...
  TDFFDataGeometry = record
    ...
    Color: packed array of TDFFprelight;
...
begin
  ...
  begin
    ...
    begin
      Stream.ReadBuffer(MaterialSplit.Split[I].FaceIndex, 8);
//      Stream.ReadBuffer(MaterialSplit.Split[I].MaterialIndex, 4); // read by trick above!!
...
begin
  ...
  rwMATERIALLIST:
    begin
      ...
      begin
        Stream.ReadBuffer(MaterialCount, 8);
//        Stream.ReadBuffer(Other, 4); read by trick above
      end;
    end;
  ...
  rwATOMIC:
    begin
    Stream.ReadBuffer(Clump[High(Clump)].Atomic[Clump[High(Clump)].AtomicCount - 1].Data, 16);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          stream.readbuffer(Frame[I].Matrix, 56);
