...
class MapWorkshop(_ToolMenuMixin, QWidget):
    ...
    # _decode_iff_ilbm/_decode_amiga_info/_decode_newicon_im1/
    # _batch_convert_icons/_batch_convert_textures/
    # _make_checkerboard removed - confirmed dead DP5 icon/bitmap
    # conversion code (Amiga .info/NewIcon/IFF ILBM formats),
    # unreachable from any live entry point and unrelated to Map
