#!/usr/bin/env python3
#this belongs in root /apps/app_info.py - Version: 9
...
App_build = "September 12 2026"
App_build_num = "Build 431"          # increment manually with each release
App_imgfactory_version = 102          # mirrors Version: N in imgfactory.py — increment on every change
App_auth  = "X-Seti"
