#!/usr/bin/env python3
#this belongs in root /apps/app_info.py - Version: 3
...
App_build_num = "Build 369"          # increment manually with each release
App_imgfactory_version = 79          # mirrors Version: N in imgfactory.py — increment on every change
App_auth  = "X-Seti"
